Pod::Spec.new do |s|
  ...
  s.version     = '1.6.9'
  s.authors     = { 'iblacksun' => 'blacksun1017@gmail.com' }
  s.homepage    = 'https://github.com/iblacksun/REActivityViewController'
  s.summary     = 'Forked from romaonthego/REActivityViewController, Open source alternative to UIActivityViewController, highly customizable and compatible with iOS 5.0.'
  s.source      = { :git => 'https://github.com/iblacksun/REActivityViewController.git',
                    :tag => '1.6.9' }
